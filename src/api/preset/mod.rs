...
impl Preset {
    ...
    ///
    pub fn timeouts(&mut self, timeout: Duration, connect_timeout: Duration) -> &mut Self {
    ...
    ///
    pub fn connections(&mut self, max: usize, pool_idle_timeout: Duration) -> &mut Self {
    ...
    ///
    pub fn keepalive(&mut self, val: Option<Duration>) -> &mut Self {
    ...
    ///
    pub fn tcp_delay(&mut self) -> &mut Self {
        self.tcp_nodelay = false;
        self
    }

    /// Set minimum required TLS version for secure connections.
    pub fn min_tls(&mut self, version: tls::Version) -> &mut Self {
    ...
    ///
    pub fn debug_mode(&mut self, invalid_certificates: bool, wrong_hostnames: bool) -> &mut Self {
    ...
    ///
    pub fn http2(&mut self, prior: bool, config: Option<Http2Settings>) -> &mut Self {
    ...
    /// # }
    /// ```
    pub fn default_headers_mut(&mut self) -> HeaderMut<'_> {
    ...
    /// - `brotli`
    ///
    pub fn compressions(&mut self, gzip: bool, brotli: bool) -> &mut Self {
        self.gzip = gzip;
        self.brotli = brotli;
        self
    }
...
pub fn rest_api(user_agent: &str) -> Preset {
    let mut preset = Preset::default();
    preset.compressions(true, true).user_agent(user_agent);
    preset
        .default_headers_mut()
        .accept_json()
        .accept_encoding_standard();
...
pub fn testing(user_agent: &str) -> Preset {
    ...
    preset.default_headers_mut().accept_json();
